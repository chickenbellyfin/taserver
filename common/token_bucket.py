...
class TokenBucketPool:
    ...
    def get(self, key):
        if key in self.buckets:
            ...
            bucket = TokenBucket(self.max_tokens, self.time_window_secs, self.unit)
...
class TokenBucket:
    ...
    def consume(self, requested_tokens) -> bool:
        ...
        print(f"\t remaining {self.remaining_tokens} {self.unit}")
    ...
    def __str__(self) -> str:
        return f'{self.max_tokens} {self.unit}/{self.time_window_secs} secs'